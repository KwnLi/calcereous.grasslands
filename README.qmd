...
eu_cg <- read.csv("out/eu_tab.csv") |>
  dplyr::rename(
    `Calcareous grassland [sq. km]` = calcgrass,
    `Non-calcareous grassland [sq. km]`= noncalc_grass,
    `Grassland missing data [sq. km]` = grass_missing_data,
    `Calcareous grassland % total area` = calcgrass_pc_totalarea,
    `Calcareous grassland % grassland` = calcgrass_pc_grasstotalarea
  )

knitr::kable(eu_cg |> dplyr::select(NAME_ENGL,`Calcareous grassland [sq. km]`,`Non-calcareous grassland [sq. km]`,`Grassland missing data [sq. km]`, `Calcareous grassland % total area`, `Calcareous grassland % grassland`) |> dplyr::rename(Country = NAME_ENGL), digits = 1)
